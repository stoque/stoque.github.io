...
image: "/assets/images/imagem-principal.png"
main-class: 'jekyll'
color: '#B31917'
tags:
- jekyll
...
![Uma xícara de café com a espuma fazendo um desenho de um gato fofinho](/assets/images/cafe-de-gato.jpg)
...
![Estrutura de pastas do Jekyll](/assets/images/pastas-jekyll.png)
...
![Cara de Gato espantado com a frase Como Assim?](/assets/images/como-assim.jpg)
...
![Imagem mostrando o processo do Gulp no terminal](/assets/images/terminal-gulp.png)
...
![Imagem mostrando como se cria um repositório](/assets/images/criar-repo.png)
...
![Imagem mostrando como se cria um repositório](/assets/images/nome-repo.png)
